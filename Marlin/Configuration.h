 ...
 * :[-1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
#define SERIAL_PORT_2 -1                           //changed 18.4.20
...
#define CUSTOM_MACHINE_NAME "Sarah"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Sarah Custom Machine on 24V
  //(measured after M106 S255 with M303 E0 S210 C8)
   #define DEFAULT_Kp 35.42
   #define DEFAULT_Ki 4.32
   #define DEFAULT_Kd 72.53
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //240V 250W silicone heater Mat
  //Sarahs custom machine )
  #define DEFAULT_bedKp 157.25
  #define DEFAULT_bedKi 30.96
  #define DEFAULT_bedKd 199.66
...
#define ENDSTOPPULLUPS                                                           //changed 19.4.20
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 80, 900, 450 }  //are you sure 450 is right for E  
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 35, 0, 0 }                                                 //????????? is this correct
