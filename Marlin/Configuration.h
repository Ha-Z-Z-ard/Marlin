...
#define STRING_CONFIG_H_AUTHOR "SGEN L-Scott Reid" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Nautilus"
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.0426 // (mm) Distance from real junction edge
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -27.7, -63, -1.76 }
...
// Move Head to ( 0, 0 ) After Homing.
//#define Nozzle_to_Zero_Zero
#if ENABLED(Nozzle_to_Zero_Zero)
  #define z_safe_clearance  // Move Z up off bed to "Z_CLEARANCE_MULTI_PROBE" ensure minimal chance of collision
#endif
...
#define LEVEL_BED_CORNERS
  ...
  #define LEVEL_CORNERS_HEIGHT      0.25   // (mm) Z height of nozzle at leveling points
  #define LEVEL_CORNERS_Z_HOP       2.5   // (mm) Z height of nozzle between leveling points
...
#define SKEW_CORRECTION
  ...
  #define XY_DIAG_AC 70.3
  #define XY_DIAG_BD 70.8
  #define XY_SIDE_AD 56.1
  ...
  #define SKEW_CORRECTION_FOR_Z
    ...
    #define XZ_DIAG_AC 71.2
    #define XZ_DIAG_BD 70.5
    #define YZ_DIAG_AC 70.9
    #define YZ_DIAG_BD 70.5
    #define YZ_SIDE_AD 55.6
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIXELS 14       // Number of LEDs in the strip, larger of 2 strips if 2 neopixel strips are used
